...
import com.test.customview.Utils;
...
public class PlayAndPauseView extends View {
    ...
    //左边动画时间
    private long leftDuration = 1500;
    //右边动画时间
    ...
    //线的间隔
    private float mLineInterval = Utils.dp2px(17);
    //线的长度
    private float mLineLength = Utils.dp2px(22);
    private Paint linePaint;
    //线的粗度
    private float lineThickness = Utils.dp2px(5);
